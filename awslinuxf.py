...
Press 7 : To manage Security Group
		...
		if ("exit" in choice) or ("back" in choice):
			speak("Getting Back to main menu")
			break
		elif "close" in choice:
			sys.exit("Exiting...")
		elif choice=="1":
			pyttsx3.speak("AWS Ec2 Instance Service")
			awsec2()
		elif choice=="2":
			pyttsx3.speak("AWS EBS Volume Service")
			awsebs()
		elif choice=="3":
			pyttsx3.speak("AWS Key Service")
			awskey()
		elif choice=="4":
			pyttsx3.speak("AWS S3 Global storage Service")
			awss3()
		elif choice=="5":
			pyttsx3.speak("AWS IAM Service")
			awsiam()
		elif choice=="6":
			awscfg()
		elif choice=="7":
			pyttsx3.speak("AWS Security Group Management")
			awssg()
		else:
...
Use - ARTH/LW to view objects inside LW.
		""")
			...
			os.system("aws s3 ls")
			print("")
			bucket1=input("Enter Bucket Name: ")
...
def awssg():
	...
	while True:
		os.system("clear")
		print("""\n------- Security Group Management Menu -------
