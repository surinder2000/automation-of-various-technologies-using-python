 ...
 Press exit : To exit\n\n""",Colors.reset)
            ...
            if ("exit" in choice) or ("back" in choice):
                ...
                if 'y' in view:
                    ...
                    print(Colors.FG.red,"\n\nInvalid Input. Proceeding...",Colors.reset)
...
\n\n""")
                ...
                if cnf=='y':
                    ...
                    print(Colors.FG.red," Sorry, Invalid Input.",Colors.reset)
 ...
 Press exit : To exit\n\n""",Colors.reset)
            ...
            if ("exit" in choice) or ("back" in choice):
                ...
                os.system("aws ec2 describe-volumes --output yaml")
                vol=input("\n Volume (Id) for creating Snapshot : ")
    ...
    def AWSEBS(self):
        ...
        while True:
            os.system("clear")
            WelcomePage().HypenLine()
            message = "Elastic Block Storage (EBS)"
            print(Colors.FG.green,message.center(WelcomePage.width),Colors.reset)
            WelcomePage().HypenLine()
 ...
 Press exit : To exit\n\n""",Colors.reset)
            ...
            if ("exit" in choice) or ("back" in choice):
                ...
                print(Colors.FG.red,"Invalid Choice. Try Again!",Colors.reset)
 ...
 Press exit: To exit\n\n""",Colors.reset)
    ...
    def AWSIAM(self):
        print(" Service will available soon")

    #AWS Main Menu
    def Menu(self):
        ch = input(" Would you like to confiure AWS CLI (Y/N): ")
        if ch == "Y" or ch == "y":
            os.system("aws configure --profile myprofile")
        while True:
            os.system("clear")
            WelcomePage().HypenLine()
            message = "AWS Main Menu"
            print(Colors.FG.green,message.center(WelcomePage.width),Colors.reset)
            WelcomePage().HypenLine()
            print(Colors.FG.orange,"""\n\n Press 1 : For working on instances
